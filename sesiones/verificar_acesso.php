...
$permisos = [
    "admin" => [// empleados
                'actualizar_empleado','administrar_cronograma.php', 'buscar_empleados.php', 'carga-empleados.php',
                 'editar_empleado.php', 'eliminar_empleados.php',  'guardar_cronograma.php', 
                'guardar_empleados.php', 'guardar_licencia.php', 'solicitar_licencia.php', 'ver_cronograma.php',

                //medicos
                'actualizar_medico.php','agregar_medicos.php', 'buscar_medicos.php', 'consulta_especialidad.php',
                 'disponibilidad_medicos.php', 'editar_medico.php', 'eliminar_medicos.php',
                'especialidad_pdf.php', 'guardar_medicos.php', 'solicitar_licencia.php',

                //pacientes
                'actualizar_paciente.php','agregar_paciente.php', 'buscar_pacientes.php','consulta_informe.php',
                 'editar_paciente.php', 'eliminar_paciente.php', 'formulario-carga.php','generar_informe.php', 
                 'generar_pdf.php',

                 // sesiones
                'buscar_usuario.php', 'editar_usuario.php', 'eliminar_usuario.php', 'register.php', 'procesar_editar.php',
