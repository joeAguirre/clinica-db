<?php 
   ...
   function seccionDerecha($titulo, $agregar, $buscar, $url_agregar="#", $url_buscar="#") {   ?>
        ...
        <div class="titulo">
            ...
            <a style="position: absolute; right: 0; top:0; margin-top:10px; margin-right:10px" href="<?php echo BASE_URL . "/sesiones/cerrar_sesion.php" ?>" class="btn btn-danger btn-cerrar">Cerrar sesión</a>
        </div>
